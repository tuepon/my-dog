...
var $author$project$Main$viewSubtitle = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color(model.secondaryLight),
				$mdgriffith$elm_ui$Element$Font$size(16),
				$author$project$Main$fontTypewriter,
